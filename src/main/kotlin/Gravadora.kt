import Banco.Album
import Banco.Artista
import Banco.Musica
import Banco.Listagem
...
class Gravadora {
    ...
    fun criaMusica(artistaID: Int,nome: String, link: String,albumID: Int,duracao: String, produtor: String, descricao: String): Musica {
        val musica: Musica = Musica()
        val geradorDeNumerosRandomicos = Random(4645)

        val idFinderAlbum: Album? = lista.albunsMutableList.find { it.idAlbum == albumID }
        val idFinderArtista: Artista? = lista.artistasMutableList.find { it.idArtista == albumID }
    ...
    fun criarAlbum(nome: String,link: String, genero: String, duracao: String, produtor: String, descricao: String,capa: String,artistaId: Int): Album {
    ...
    fun editArtista( nome: String,artistaID: Int,nacionalidade: String,descricao: String,foto: String, link: String) {
        objectArtista.edit(nome, link, artistaID,nacionalidade, descricao,foto, lista)
    }
    fun editAlbum(nome: String, link: String,editID: Int,objectID: Int,genero: String,descricao: String,compositores: String, lista: Listagem,duracao: String,produtor: String, capa: String) {
        objectAlbum.editar(nome, link, editID, objectID, genero, descricao, compositores,lista, duracao, produtor, capa)
    }
    fun editMusica(nome: String, link: String,editID: Int,objectID: Int,genero: String,descricao: String,compositores: String, lista: Listagem,duracao: String,produtor: String, capa: String) {
        objectMusica.editar(nome, link, editID, objectID, genero, descricao, compositores,lista, duracao, produtor, capa)
    }
