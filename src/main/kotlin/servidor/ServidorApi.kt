...
fun Route.criarArtista() {
    post("/artistas") {
        ...
        val artistaCriado = gravadora.cadastrarArtista(artistaParaCriar.nome!!,artistaParaCriar.nacionalidade!!,artistaParaCriar.foto!!,artistaParaCriar.descricao!!)
...
fun Route.listarArtista() {
    get("/artistas") {
        call.respond(gravadora.artistasMutableList)
    }
}
